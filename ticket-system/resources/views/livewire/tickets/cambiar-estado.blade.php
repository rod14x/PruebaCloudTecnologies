                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('tickets.show', $ticket->id) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">
                                Ticket #{{ $ticket->id }}
                            </a>
                        </div>
                    </li>
                ...
                <form wire:submit.prevent="cambiarEstado">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-3 pt-6 border-t border-gray-200">
                        ...
                        <button 
                            ...
                            class="inline-flex items-center px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
